...
%--- CIRCUIT_NAME_FILE --------
CIRCUIT_NAME_FILE =  'circuit_2000x2000.dev1.png';
...
INITIAL_ROBOT_POS_THETA = 1.5*2; % not exactly pi, 
%for circuit_2000x2000.dev2.png
...
%kd_teta=1/(alpha*4*omega*omega) % originally without kd
